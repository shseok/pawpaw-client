...
export default function ScheduleListModal({ setModalType }: PropsType) {
  return (
    <div className="fixed top-0 bottom-0 left-0 right-0 w-full h-full bg-white tablet:hidden">
